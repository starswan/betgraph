...
ActiveRecord::Schema.define(version: 2024_03_01_070930) do
  ...
  create_table "basket_rule_items", force: :cascade do |t|
  ...
  create_table "basket_rules", force: :cascade do |t|
  ...
  create_table "bet_markets", force: :cascade do |t|
  ...
  create_table "football_divisions", force: :cascade do |t|
  ...
  create_hypertable "prices", time_column: "created_at", chunk_time_interval: "7 days", compress_segmentby: "market_runner_id", compress_orderby: "created_at ASC", compression_interval: "P7D"
end
