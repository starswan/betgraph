...
docker run -d --rm --name betgraph_postgres -p 5433:5432 -v betgraph_postgres:/var/lib/postgresql/data -e TZ=London -e POSTGRES_PASSWORD=password timescale/timescaledb:latest-pg14
